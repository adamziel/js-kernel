        ...
        const program = async function main(urls: {
                ...
                const render = () => {
                        ...
                        if (searchActive) {
                                ...
                                const match = hasMatch ? history[searchMatches[searchMatchPointer]] : ''
                ...
                const leaveSearchMode = (applyMatch: boolean) => {
                        ...
                        if (
                                applyMatch &&
                                searchMatchPointer < searchMatches.length
                        ) {
                ...
                const gatherCommandCompletions = (prefix: string) => {
                        ...
                        results.sort((a, b) => (a.display < b.display ? -1 : a.display > b.display ? 1 : 0))
                        return results
                }
                ...
                const interpretEscape = (sequence: string) => {
                        ...
                        const controlMatch = sequence.match(/\u001b\[(\d+);(\d+)([A-Za-z])/)
                        if (controlMatch) {
