...
// Begin JS library code
  ...
  allocateUnusedWorker() {
        ...
        worker = new Worker(/* @vite-ignore */ new URL('wasmfs-fs.js', import.meta.url), /* @vite-ignore */ {
          'type': 'module',
          // This is the way that we signal to the Web Worker that it is hosting
          // a pthread.
          'name': 'em-pthread-' + PThread.nextWorkerID,
...
var _fs_fdatasync = Module['_fs_fdatasync'] = makeInvalidEarlyAccess('_fs_fdatasync');
...
var _fs_unlink = Module['_fs_unlink'] = makeInvalidEarlyAccess('_fs_unlink');
var _fs_rename = Module['_fs_rename'] = makeInvalidEarlyAccess('_fs_rename');
var _fs_chmod = Module['_fs_chmod'] = makeInvalidEarlyAccess('_fs_chmod');
var _fs_fchmod = Module['_fs_fchmod'] = makeInvalidEarlyAccess('_fs_fchmod');
var _fs_truncate = Module['_fs_truncate'] = makeInvalidEarlyAccess('_fs_truncate');
var _fs_ftruncate = Module['_fs_ftruncate'] = makeInvalidEarlyAccess('_fs_ftruncate');
var _fs_access = Module['_fs_access'] = makeInvalidEarlyAccess('_fs_access');
var _fs_getcwd = Module['_fs_getcwd'] = makeInvalidEarlyAccess('_fs_getcwd');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_fs_fdatasync'] = _fs_fdatasync = createExportWrapper('fs_fdatasync', 1);
  ...
  Module['_fs_truncate'] = _fs_truncate = createExportWrapper('fs_truncate', 2);
  Module['_fs_ftruncate'] = _fs_ftruncate = createExportWrapper('fs_ftruncate', 2);
